...
export function BetStats({selections = []}:BetStatsProps) {
    return (
        <div
            className="bg-gradient-to-t from-[#FFD700] to-[#F59D06] flex items-center justify-center w-[48rem] rounded-br-full rounded-bl-full h-[4rem] z-10">
            <div className="w-2/6 px-6 text-center flex items-center justify-center">
